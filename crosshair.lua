...
local drawings = {
    crosshair = {},
    text = {
        Drawing.new('Text', {Size = 13, Font = 2, Outline = true, Text = 'Nebula', Color = Color3.fromRBG(85, 170, 255)}),
        Drawing.new('Text', {Size = 13, Font = 2, Outline = true, Text = " X"}, Color = Color3.fromRBG(255,255,255)),
